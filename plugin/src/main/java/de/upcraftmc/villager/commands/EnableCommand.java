...
/**
 * AntiVillagerLag; de.upcraftmc.villager.commands:EnableCommand
 *
 * @author <a href="https://github.com/LuciferMorningstarDev">LuciferMorningstarDev</a>
 * @since 19.03.2023
 */
public class EnableCommand implements AVLSubCommand {

    private UpCraftAntiVillagerLagPlugin plugin;

    public EnableCommand(UpCraftAntiVillagerLagPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean run(final Player sender, final List subArgs) {
        ...
        VillagerUtiils.setShouldBeDisabled(v, plugin, false);
        VillagerUtiils.setIgnore(v, plugin, true);
        sender.sendMessage(ComponentSerializer.etAndHEX.deserialize("&aDer Villager wurde aktiviert."));
